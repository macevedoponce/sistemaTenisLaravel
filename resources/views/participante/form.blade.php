<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('apellidos_nombres') }}
            {{ Form::text('apellidos_nombres', $participante->apellidos_nombres, ['class' => 'form-control' . ($errors->has('apellidos_nombres') ? ' is-invalid' : ''), 'placeholder' => 'Apellidos Nombres']) }}
            {!! $errors->first('apellidos_nombres', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            {{ Form::label('celular') }}
            {{ Form::text('celular', $participante->celular, ['class' => 'form-control' . ($errors->has('celular') ? ' is-invalid' : ''), 'placeholder' => 'Celular']) }}
