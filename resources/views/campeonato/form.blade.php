<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('tipo_campeonato_id', $tipocampeonatos, $campeonato->tipo_campeonato_id, ['class' => 'form-control' . ($errors->has('tipo_campeonato_id') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Campeonato Id']) }}
