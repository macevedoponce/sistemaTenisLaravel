...
class CampeonatoController extends Controller
{
    ...
    public function create()
    {
        ...
        $tipo_campeonato = Tipocampeonato::pluck('nombreTipoCampeonato','id');
        return view('campeonato.create', compact('campeonato','tipo_campeonato'));
    }
    ...
    public function edit($id)
    {
        $campeonato = Campeonato::find($id);
        $tipo_campeonato = Tipocampeonato::pluck('nombreTipoCampeonato','id');
        return view('campeonato.edit', compact('campeonato','tipo_campeonato'));
    }
