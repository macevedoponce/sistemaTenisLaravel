...
class CampeonatoController extends Controller
{
    ...
    public function create()
    {
        ...
        $tipocampeonatos = Tipocampeonato::pluck('nombreTipoCampeonato','id');
        return view('campeonato.create', compact('campeonato','tipocampeonatos'));
    }
    ...
    public function edit($id)
    {
        $campeonato = Campeonato::find($id);
        $tipocampeonatos = Tipocampeonato::pluck('nombreTipoCampeonato','id');
        return view('campeonato.edit', compact('campeonato','tipocampeonatos'));
    }
