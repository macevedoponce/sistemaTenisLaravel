...
class ResultadoController extends Controller
{
    ...
    public function create()
    {
        ...
        $partidos = Partido::all(); //aqui modificar para que aparezcan los nombres de los competidores
        //dependiendo de la cantidad de sets que tenga dicho partido debe mostrar los sets y al momento de guardar debe de registrarse todos los sets en conjuntos
        return view('resultado.create', compact('resultado','partidos'));
    }
