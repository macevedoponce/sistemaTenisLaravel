...
class PartidoController extends Controller
{
    ...
    public function create()
    {
        ...
        $jugadores = Participante::pluck('apellidosNombres','id');
        return view('partido.create', compact('partido','campeonatos','categorias','jugadores'));
    }
    ...
    public function edit($id)
    {
        ...
        $categorias = Categoria::pluck('nombreCategoria','id');
        $jugadores = Participante::pluck('apellidosNombres','id');
        return view('partido.edit', compact('partido','campeonatos','categorias','jugadores'));
    }
